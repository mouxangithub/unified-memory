...
export function registerRuleTools(server) {
  server.registerTool('memory_rule_add', { description: '...', inputSchema: z.object({}) }, memory_rule_add);
  server.registerTool('memory_rule_list', { description: '...', inputSchema: z.object({}) }, memory_rule_list);
  server.registerTool('memory_rule_check', { description: '...', inputSchema: z.object({}) }, memory_rule_check);
  server.registerTool('memory_rule_delete', { description: '...', inputSchema: z.object({}) }, memory_rule_delete);
}
