...
> **Version 0.8.0** | An intelligent memory system designed for AI Agents with hierarchical caching, knowledge merging, predictive loading, automatic maintenance, proactive injection, adaptive confidence, audit logging, multi-agent sync, sensitive data encryption, prediction, and multimodal support.
