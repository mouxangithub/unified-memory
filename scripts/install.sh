...
cd "$(dirname "$0")"
python3 scripts/memory_v7.py status 2>/dev/null || echo "  ⚠️ Status check skipped"
...
echo "   2. Run: python3 scripts/memory_v7.py init"
echo "   3. Check status: python3 scripts/memory_v7.py status"
echo ""
